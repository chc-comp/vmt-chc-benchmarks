;; translated from ./lustre/durationThm_1_e2_3_e7_336.vmt
...
(assert (forall ((|k__AT0| Int) (|call_Sofar.flby__AT0| Bool) (|call_Age.xite__AT0| Int) (|call_Age2.xite__AT0| Int) (|call_Age3.xite__AT0| Int) (|param_p__AT1| Bool) (|param_ik__AT1| Int) (|param_im__AT1| Int) (|call_Age.age_of_p__AT0| Int) (|param_ik__AT0| Int) (|flby__AT0| Int) (|param_im__AT0| Int) (|flby2__AT0| Int) (|flby3__AT0| Bool) (|call_Age.flby__AT0| Int) (|call_Age2.flby__AT0| Int) (|call_Age3.flby__AT0| Int) (|_OK___AT0| Bool) (|env__AT0| Bool) (|call_Sofar.Sofar__AT0| Bool) (|call_Age3.age_of_p__AT0| Int) (|flby__AT1| Int) (|flby2__AT1| Int) (|k__AT1| Int) (|m__AT1| Int) (|call_Age3.age_of_p__AT1| Int) (|param_r__AT1| Bool) (|flby3__AT1| Bool) (|call_Age.xite__AT1| Int) (|param_p__AT0| Bool) (|call_Age3.xite__AT1| Int) (|call_Age2.xite__AT1| Int) (|call_Age.flby__AT1| Int) (|call_Age2.flby__AT1| Int) (|call_Age2.age_of_p__AT1| Int) (|param_q__AT1| Bool) (|call_Age.age_of_p__AT1| Int) (|call_Sofar.flby__AT1| Bool) (|call_Age3.flby__AT1| Int) (|_OK___AT1| Bool) (|env__AT1| Bool) (|call_Sofar.Sofar__AT1| Bool) (|param_r__AT0| Bool) (|call_Age2.age_of_p__AT0| Int) (|m__AT0| Int) (|param_q__AT0| Bool)) (=> (and (state |call_Age3.flby__AT0| |call_Age3.age_of_p__AT0| |call_Sofar.flby__AT0| |call_Sofar.Sofar__AT0| |call_Age2.flby__AT0| |call_Age2.age_of_p__AT0| |call_Age.flby__AT0| |call_Age.age_of_p__AT0| |env__AT0| |flby2__AT0| |m__AT0| |flby__AT0| |k__AT0| |flby3__AT0| |_OK___AT0| |param_im__AT0| |param_ik__AT0| |param_q__AT0| |param_r__AT0| |param_p__AT0| |call_Age.xite__AT0| |call_Age2.xite__AT0| |call_Age3.xite__AT0|) (let ((.def_157 (= k__AT0 flby__AT1)))
(let ((.def_156 (= m__AT0 flby2__AT1)))
(let ((.def_158 (and .def_156 .def_157)))
(let ((.def_148 (* (- 1) k__AT1)))
(let ((.def_149 (* (- 1) m__AT1)))
(let ((.def_150 (+ .def_149 .def_148)))
(let ((.def_151 (+ call_Age3.age_of_p__AT1 .def_150)))
(let ((.def_152 (<= 0 .def_151)))
(let ((.def_153 (not .def_152)))
(let ((.def_154 (or param_r__AT1 .def_153)))
(let ((.def_155 (= flby3__AT1 .def_154)))
(let ((.def_159 (and .def_155 .def_158)))
(let ((.def_139 (= call_Age.xite__AT1 0)))
(let ((.def_140 (or param_p__AT0 .def_139)))
(let ((.def_137 (= call_Age.age_of_p__AT0 call_Age.xite__AT1)))
(let ((.def_135 (not param_p__AT0)))
(let ((.def_138 (or .def_135 .def_137)))
(let ((.def_141 (and .def_138 .def_140)))
(let ((.def_134 (= call_Age3.age_of_p__AT0 call_Age3.xite__AT1)))
(let ((.def_136 (or .def_134 .def_135)))
(let ((.def_142 (and .def_136 .def_141)))
(let ((.def_131 (= call_Age3.xite__AT1 0)))
(let ((.def_133 (or .def_131 param_p__AT0)))
(let ((.def_143 (and .def_133 .def_142)))
(let ((.def_160 (and .def_143 .def_159)))
(let ((.def_128 (= call_Age2.xite__AT1 0)))
(let ((.def_129 (or param_q__AT0 .def_128)))
(let ((.def_126 (= call_Age2.age_of_p__AT0 call_Age2.xite__AT1)))
...
.def_166))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (state |call_Age3.flby__AT1| |call_Age3.age_of_p__AT1| |call_Sofar.flby__AT1| |call_Sofar.Sofar__AT1| |call_Age2.flby__AT1| |call_Age2.age_of_p__AT1| |call_Age.flby__AT1| |call_Age.age_of_p__AT1| |env__AT1| |flby2__AT1| |m__AT1| |flby__AT1| |k__AT1| |flby3__AT1| |_OK___AT1| |param_im__AT1| |param_ik__AT1| |param_q__AT1| |param_r__AT1| |param_p__AT1| |call_Age.xite__AT1| |call_Age2.xite__AT1| |call_Age3.xite__AT1|))))
