;; translated from ./lustre/two_counters_e7_222.vmt
...
(let ((.def_28 (or call_greycounter.b__AT0 call_greycounter.a__AT0)))
...
(let ((.def_58 (or call_greycounter.b__AT1 call_greycounter.a__AT1)))
...
.def_96))))))))))))))))))))))))))))))))))))))))))))))))))))))) (state |call_intloopcounter.flby__AT1| |call_greycounter.flby2__AT1| |call_greycounter.flby__AT1| |call_intloopcounter.time__AT1| |call_intloopcounter.out__AT1| |call_greycounter.b__AT1| |call_greycounter.a__AT1| |call_greycounter.out__AT1| |d__AT1| |b__AT1| |_OK___AT1| |param_x__AT1| |call_intloopcounter.xite__AT1|))))
