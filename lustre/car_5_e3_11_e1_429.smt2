;; translated from ./lustre/car_5_e3_11_e1_429.vmt
...
(let ((.def_253 (and call_voiture.meter__AT1 call_voiture.move__AT1)))
(let ((.def_264 (or .def_253 .def_263)))
(let ((.def_259 (* (- 1) call_voiture.xite2__AT1)))
(let ((.def_260 (+ call_voiture.speed__AT0 .def_259)))
(let ((.def_261 (= .def_260 1)))
(let ((.def_254 (not .def_253)))
(let ((.def_262 (or .def_254 .def_261)))
(let ((.def_265 (and .def_262 .def_264)))
(let ((.def_256 (= call_voiture.dist__AT0 call_voiture.xite__AT1)))
...
(let ((.def_247 (= call_voiture.time__AT0 call_voiture.xite4__AT1)))
(let ((.def_248 (or call_voiture.second__AT1 .def_247)))
