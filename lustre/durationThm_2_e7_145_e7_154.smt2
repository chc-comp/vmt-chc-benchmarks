;; translated from ./lustre/durationThm_2_e7_145_e7_154.vmt
...
(let ((.def_104 (<= k__AT1 call_Age2.age_of_p__AT1)))
(let ((.def_105 (not .def_104)))
(let ((.def_106 (or param_t__AT1 .def_105)))
