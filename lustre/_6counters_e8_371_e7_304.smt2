;; translated from ./lustre/_6counters_e8_371_e7_304.vmt
...
(let ((.def_93 (not call_bool6.b__AT0)))
(let ((.def_94 (and call_bool6.a__AT0 .def_93)))
(let ((.def_92 (not call_bool6.c__AT0)))
