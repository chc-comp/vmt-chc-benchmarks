;; translated from ./lustre/car_all_e3_1068_e1_178.vmt
...
(let ((.def_270 (and call_voiture.meter__AT1 call_voiture.move__AT1)))
(let ((.def_281 (or .def_270 .def_280)))
(let ((.def_276 (* (- 1) call_voiture.xite2__AT1)))
(let ((.def_277 (+ call_voiture.speed__AT0 .def_276)))
(let ((.def_278 (= .def_277 1)))
(let ((.def_271 (not .def_270)))
(let ((.def_279 (or .def_271 .def_278)))
(let ((.def_282 (and .def_279 .def_281)))
(let ((.def_273 (= call_voiture.dist__AT0 call_voiture.xite__AT1)))
(let ((.def_274 (or .def_270 .def_273)))
(let ((.def_267 (* (- 1) call_voiture.xite__AT1)))
(let ((.def_268 (+ call_voiture.dist__AT0 .def_267)))
(let ((.def_269 (= .def_268 (- 1))))
(let ((.def_272 (or .def_269 .def_271)))
(let ((.def_275 (and .def_272 .def_274)))
(let ((.def_283 (and .def_275 .def_282)))
(let ((.def_264 (= call_voiture.time__AT0 call_voiture.xite4__AT1)))
(let ((.def_265 (or call_voiture.second__AT1 .def_264)))
