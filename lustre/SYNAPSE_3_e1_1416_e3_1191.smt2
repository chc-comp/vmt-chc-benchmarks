;; translated from ./lustre/SYNAPSE_3_e1_1416_e3_1191.vmt
...
(let ((.def_396 (* (- 1) call_synapse.invalid_s__AT0)))
(let ((.def_397 (+ .def_396 call_synapse.xite2__AT1)))
(let ((.def_398 (* (- 1) call_synapse.valid_s__AT0)))
(let ((.def_399 (+ .def_398 .def_397)))
(let ((.def_400 (+ call_synapse.dirty_s__AT0 .def_399)))
