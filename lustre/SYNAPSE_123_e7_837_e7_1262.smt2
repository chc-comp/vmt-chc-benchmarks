;; translated from ./lustre/SYNAPSE_123_e7_837_e7_1262.vmt
...
(let ((.def_19 (and param_e_s1__AT0 param_e_s3__AT0)))
(let ((.def_17 (or param_e_s2__AT0 param_e_s1__AT0)))
...
(let ((.def_453 (+ invalid_s__AT0 .def_291)))
(let ((.def_454 (+ valid_s__AT0 .def_453)))
(let ((.def_455 (+ dirty_s__AT0 .def_454)))
(let ((.def_456 (= .def_455 0)))
(let ((.def_457 (= flby__AT1 .def_456)))
(let ((.def_441 (= call_synapse.invalid_s__AT0 call_synapse.xite4__AT1)))
...
(let ((.def_423 (= call_synapse.invalid_s__AT0 call_synapse.xite__AT1)))
(let ((.def_424 (or call_synapse.garde_s1__AT1 .def_423)))
(let ((.def_416 (* (- 1) call_synapse.xite__AT1)))
(let ((.def_419 (+ call_synapse.invalid_s__AT0 .def_416)))
(let ((.def_420 (+ call_synapse.dirty_s__AT0 .def_419)))
...
(let ((.def_338 (or call_Sofar.Sofar__AT0 .def_337)))
...
(let ((.def_208 (and param_e_s1__AT1 param_e_s3__AT1)))
(let ((.def_206 (or param_e_s1__AT1 param_e_s2__AT1)))
