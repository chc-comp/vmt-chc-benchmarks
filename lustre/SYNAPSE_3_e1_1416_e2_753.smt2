;; translated from ./lustre/SYNAPSE_3_e1_1416_e2_753.vmt
...
(let ((.def_401 (* (- 1) call_synapse.xite__AT1)))
(let ((.def_404 (+ call_synapse.invalid_s__AT0 .def_401)))
...
(let ((.def_396 (+ call_synapse.invalid_s__AT0 .def_391)))
(let ((.def_397 (+ call_synapse.valid_s__AT0 .def_396)))
(let ((.def_398 (+ call_synapse.dirty_s__AT0 .def_397)))
